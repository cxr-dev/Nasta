...
<style>
  .disruption-strip { padding: 16px; border-top: 1px solid var(--border); background: var(--color-warning-subtle); }
  .disruption-header { display: flex; align-items: center; gap: 8px; margin-bottom: 12px; color: var(--color-warning); font-weight: 700; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; }
