...
const sv = {
  ...
  reorderCards: "Ordna kort",
  moveUp: "Flytta upp",
  moveDown: "Flytta ned",
  manualOrderDescription: "Manuell ordning sparas för den här sidan. Gruppering ändrar visningen men bevarar ordningen.",
...
const en: typeof sv = {
  ...
  moveUp: "Move up",
  moveDown: "Move down",
  manualOrderDescription: "Manual order is saved for this page. Grouping changes the presentation while preserving the order.",
